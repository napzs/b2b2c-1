...
class SyncController extends Controller {
    ...
    public function actionPost() {
        $update = Topic::updateAll(['last_comment_time' => new Expression('created_at')], //            ['or', ['type' => Topic::TYPE, 'last_comment_username' => ''], ['type' => Topic::TYPE, 'last_comment_username' => null]]
            [
                'and',
                ['type' => Topic::TYPE],
                ['or', ['last_comment_username' => ''], ['last_comment_username' => null]]
            ]);
        ...
        foreach ($comment as $value) {
            $commentCount = PostComment::find()->where([
